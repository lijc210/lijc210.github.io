import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,o as a,d as e}from"./app-tvDIMFr5.js";const t={},i=e(`<h1 id="反向代理应用frp" tabindex="-1"><a class="header-anchor" href="#反向代理应用frp"><span>反向代理应用frp</span></a></h1><p>拥有公网IP的情况下，可以使用frp来实现内网机器的端口映射和访问。</p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><p>linux</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>wget https://github.com/fatedier/frp/releases/download/v0.57.0/frp_0.57.0_linux_amd64.tar.gz
