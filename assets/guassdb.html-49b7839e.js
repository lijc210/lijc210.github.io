import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as i,e as s}from"./app-0e73dd48.js";const n={},r=s(`<h1 id="guassdb" tabindex="-1"><a class="header-anchor" href="#guassdb" aria-hidden="true">#</a> guassdb</h1><h2 id="优化" tabindex="-1"><a class="header-anchor" href="#优化" aria-hidden="true">#</a> 优化</h2><ul><li>1、删除表dim_shop_sales_target在字段target_date上的索引（注：列存表非必要无需创建索引，如创建，可选用btree索引，不要创建默认的psort索引，贵司当前列存表上，基本都是psort索引）</li><li>2、dim_jd_erp_shop表，建议修改为复制表（数据总量较小的维度表，建议调整为复制表）</li></ul><h2 id="自动更新时间" tabindex="-1"><a class="header-anchor" href="#自动更新时间" aria-hidden="true">#</a> 自动更新时间</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>CREATE TABLE public.ads_order_city_rank (
