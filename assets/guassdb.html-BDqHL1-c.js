...
sdate,
store_shop_code;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>-- 最近一年明细数据量为 3400 万条<br> -- 查询最近一年用户明细（耗时442毫秒）</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>SELECT sdate, bitmapToArray(users) FROM tmp.member_order_bitmap
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,26);function o(_,g){const t=n("ExternalLinkIcon");return d(),r("div",null,[m,i("p",null,[e("如有多张bitmap表可以进行交并计算（要比普通的用户表进行JOIN或者IN计算要高效很多）"),u,e(" clickhouse同样提供了一系列函数来进行bitmap之间的集合运算，包括并集、交集、差集、补集等。"),p,e(" 具体使用可查阅官方文档：bitmap函数"),i("a",v,[e("https://clickhouse.com/docs/zh/sql-reference/functions/bitmap-functions/"),l(t)])]),b])}const h=s(c,[["render",o],["__file","guassdb.html.vue"]]),T=JSON.parse(`{"path":"/%E5%A4%A7%E6%95%B0%E6%8D%AE/%E6%95%B0%E6%8D%AE%E5%BA%93/guassdb.html","title":"guassdb","lang":"zh-CN","frontmatter":{"icon":"edit","date":"2022-01-01T00:00:00.000Z","category":["数据库"],"tag":["guassdb"],"description":"guassdb 优化 1、删除表dim_shop_sales_target在字段target_date上的索引（注：列存表非必要无需创建索引，如创建，可选用btree索引，不要创建默认的psort索引，贵司当前列存表上，基本都是psort索引） 2、dim_jd_erp_shop表，建议修改为复制表（数据总量较小的维度表，建议调整为复制表） 自动更新时...","head":[["meta",{"property":"og:url","content":"https://www.cizai.io/%E5%A4%A7%E6%95%B0%E6%8D%AE/%E6%95%B0%E6%8D%AE%E5%BA%93/guassdb.html"}],["meta",{"property":"og:site_name","content":"此在笔记"}],["meta",{"property":"og:title","content":"guassdb"}],["meta",{"property":"og:description","content":"guassdb 优化 1、删除表dim_shop_sales_target在字段target_date上的索引（注：列存表非必要无需创建索引，如创建，可选用btree索引，不要创建默认的psort索引，贵司当前列存表上，基本都是psort索引） 2、dim_jd_erp_shop表，建议修改为复制表（数据总量较小的维度表，建议调整为复制表） 自动更新时..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-11-20T05:41:15.000Z"}],["meta",{"property":"article:author","content":"cizai"}],["meta",{"property":"article:tag","content":"guassdb"}],["meta",{"property":"article:published_time","content":"2022-01-01T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2023-11-20T05:41:15.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"guassdb\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2022-01-01T00:00:00.000Z\\",\\"dateModified\\":\\"2023-11-20T05:41:15.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"cizai\\",\\"url\\":\\"https://www.cizai.io\\"}]}"]]},"headers":[{"level":2,"title":"优化","slug":"优化","link":"#优化","children":[]},{"level":2,"title":"自动更新时间","slug":"自动更新时间","link":"#自动更新时间","children":[]},{"level":2,"title":"常用命令","slug":"常用命令","link":"#常用命令","children":[]},{"level":2,"title":"Clickhouse bitmap用法","slug":"clickhouse-bitmap用法","link":"#clickhouse-bitmap用法","children":[{"level":3,"title":"bitmap性能测试:","slug":"bitmap性能测试","link":"#bitmap性能测试","children":[]}]}],"git":{"createdTime":1689218642000,"updatedTime":1700458875000,"contributors":[{"name":"lijc210","email":"lijc210@163.com","commits":4}]},"readingTime":{"minutes":4.93,"words":1480},"filePathRelative":"大数据/数据库/guassdb.md","localizedDate":"2022年1月1日","excerpt":"\\n<h2>优化</h2>\\n<ul>\\n<li>1、删除表dim_shop_sales_target在字段target_date上的索引（注：列存表非必要无需创建索引，如创建，可选用btree索引，不要创建默认的psort索引，贵司当前列存表上，基本都是psort索引）</li>\\n<li>2、dim_jd_erp_shop表，建议修改为复制表（数据总量较小的维度表，建议调整为复制表）</li>\\n</ul>\\n<div class=\\"language-text\\" data-ext=\\"text\\" data-title=\\"text\\"><pre class=\\"language-text\\"><code>在各DN的数据分布倾斜\\nselect table_skewness('ads_sales_shop_notdis');\\n\\n</code></pre></div>","autoDesc":true}`);export{h as comp,T as data};
