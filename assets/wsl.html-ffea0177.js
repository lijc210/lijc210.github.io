import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as n}from"./app-f051da8a.js";const i={},d=n(`<h1 id="wsl" tabindex="-1"><a class="header-anchor" href="#wsl" aria-hidden="true">#</a> wsl</h1><h2 id="列出wsl子系统" tabindex="-1"><a class="header-anchor" href="#列出wsl子系统" aria-hidden="true">#</a> 列出WSL子系统</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>wslconfig /list
wsl --list
wsl -l -v
