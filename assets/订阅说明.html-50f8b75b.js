import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,e as s}from"./app-9e4b5a6a.js";const d={},l=s(`<h1 id="订阅说明" tabindex="-1"><a class="header-anchor" href="#订阅说明" aria-hidden="true">#</a> 订阅说明</h1><h2 id="实现原理" tabindex="-1"><a class="header-anchor" href="#实现原理" aria-hidden="true">#</a> 实现原理</h2><p>使用ttrss.py启动订阅服务接口，使用rsshub订阅插件，将Tiny Tiny RSS地址改为订阅接口地址，即可直接订阅网站，存入rss.csv。</p><p>定时执行write2csv.py<span></span>，抓取网络上的订阅地址，存入rss.csv。</p><p>定时执行write2md.py<span></span>，读取rss.csv，获取今日新增文章，写入md文档，提交git，自动显示在每日悦读。</p><p>参考代码：</p><h2 id="ttrss-py" tabindex="-1"><a class="header-anchor" href="#ttrss-py" aria-hidden="true">#</a> ttrss.py<span></span></h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># coding: utf-8
&quot;&quot;&quot;
@File    :   main.py
