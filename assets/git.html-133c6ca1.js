...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这将创建一个新的分支，添加所有文件，提交并删除原来的主分支，最后将当前分支重命名为主分支并将其推送到远程仓库。请注意，这将删除所有历史记录，包括分支和标记。</p><h2 id="git-pull报错fatal-refusing-to-merge-unrelated-histories" tabindex="-1"><a class="header-anchor" href="#git-pull报错fatal-refusing-to-merge-unrelated-histories" aria-hidden="true">#</a> git pull报错fatal: refusing to merge unrelated histories</h2><p>git push命令中添加–allow-unrelated-histories</p><h2 id="git新增一个推送地址" tabindex="-1"><a class="header-anchor" href="#git新增一个推送地址" aria-hidden="true">#</a> git新增一个推送地址</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>git remote set-url --add origin &lt;url&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,9);function h(m,v){const a=n("ExternalLinkIcon");return d(),s("div",null,[o,e("p",null,[e("a",g,[r("https://github.com/gitpython-developers/GitPython/discussions/1458"),l(a)])]),u])}const x=t(c,[["render",h],["__file","git.html.vue"]]);export{x as default};
