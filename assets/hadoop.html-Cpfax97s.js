import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as t,c as i,e as a}from"./app-Jrt1aRX8.js";const n={},s=a(`<h1 id="hadoop" tabindex="-1"><a class="header-anchor" href="#hadoop"><span>hadoop</span></a></h1><h2 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令"><span>常用命令</span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>hadoop fs -ls /
hadoop fs -ls /user
hadoop fs -ls /kn1
