import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as e,e as d}from"./app-4b5d86eb.js";const l={},s=d(`<h1 id="终端" tabindex="-1"><a class="header-anchor" href="#终端" aria-hidden="true">#</a> 终端</h1><h2 id="终端配置" tabindex="-1"><a class="header-anchor" href="#终端配置" aria-hidden="true">#</a> 终端配置</h2><p>linux，mac下用alacritty终端，windows下使用自带Terminal<br> brew install alacritty</p><h3 id="zsh安装和oh-my-zsh" tabindex="-1"><a class="header-anchor" href="#zsh安装和oh-my-zsh" aria-hidden="true">#</a> zsh安装和oh-my-zsh</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>apt install zsh
chsh -s /bin/zsh
