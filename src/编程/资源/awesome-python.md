...
* OAuth
  ...
  * [django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit)-OAuth 2 Django的好东西。
  * [oauthlib](https://github.com/idan/oauthlib)-OAuth请求签名逻辑的通用和彻底的实现。
  * [python-oauth2](https://github.com/joestump/python-oauth2)-一个经过全面测试的抽象接口，用于创建OAuth客户端和服务器。
...
* [BitBake](http://www.yoctoproject.org/docs/1.6/bitbake-user-manual/bitbake-user-manual.html)-用于嵌入式Linux的类似制作的构建工具。
...
* [Kotti](https://github.com/Kotti/Kotti)-一个基于python的高级web应用程序框架。
* [mezzanine](https://github.com/stephenmcd/mezzanine)-功能强大、一致且灵活的内容管理平台。
* [plone](https://plone.org/)-构建在开源应用程序服务器Zope之上的CMS。
...
* [dogpile.cache](http://dogpilecache.readthedocs.io/en/latest/)-dogpile.ca che是由同一作者制作的烧杯的下一代替代品。
...
* [python-diskcache](http://www.grantjenks.com/docs/diskcache/)-SQLite和文件支持的缓存后端，具有比memcached和redis更快的查找速度。
## ChatOps工具
...
* 代码分析
  * [coala](https://github.com/coala/coala/)-语言独立和易于扩展的代码分析应用程序。
  ...
  * [pycallgraph](https://github.com/gak/pycallgraph)-一个可视化Python应用程序流 (调用图) 的库。
  * [vulture](https://github.com/jendrikseipp/vulture)-用于查找和分析死Python代码的工具。
* 代码短绒
  * [flake8](https://pypi.org/project/flake8/)-周围的包装,还有McCabe.
  * [awesome-flake8-extensions](https://github.com/DmytroLitvinov/awesome-flake8-extensions)
  * [pylama](https://github.com/klen/pylama)-用于Python和JavaScript的代码审核工具。
  * [pylint](https://www.pylint.org/)-一个完全可定制的源代码分析器。
  * [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide)-有史以来最严格，最固执己见的python棉绒。
* 代码格式化程序
  * [black](https://github.com/python/black)-不妥协的Python代码格式化程序。
...
* 命令行应用程序开发
  ...
  * [click](http://click.pocoo.org/dev/)-用于以组合方式创建漂亮的命令行界面的软件包。
...
* 终端渲染
  ...
  * [rich](https://github.com/willmcgugan/rich)-用于终端中富文本和漂亮格式的Python库。还提供了一个伟大的日志处理程序。
...
* 生产力工具
  ...
  * [Invoke](https://github.com/pyinvoke/invoke#readme)-用于管理面向shell的子进程并将可执行的Python代码组织到CLI可调用的任务中的工具。
  * [PathPicker](https://github.com/facebook/PathPicker)-从bash输出中选择文件。
  * [percol](https://github.com/mooz/percol)-在UNIX上的传统管道概念中添加了交互式选择的味道。
...
* CLI增强功能
  * [httpie](https://github.com/jakubroztocil/httpie)一个命令行HTTP客户端，一个用户友好的cURL替换。
  * [iredis](https://github.com/laixintao/iredis)-具有自动完成和语法突出显示功能的Redis CLI。
  * [kube-shell](https://github.com/cloudnativelabs/kube-shell)-用于使用Kubernetes CLI的集成shell。
  ...
  * [saws](https://github.com/donnemartin/saws)-一个增压[aws-cli](https://github.com/aws/aws-cli)。
## 兼容性

*从Python 2迁移到3的库。* 

* [python-future](http://python-future.org/index.html)-Python 2和Python 3之间缺少的兼容层。
* [modernize](https://github.com/PyCQA/modernize)-为最终的Python 3迁移实现Python代码的现代化。
...
*用于并发和并行执行的库。另请参见[awesome-asyncio](https://github.com/timofurrer/awesome-asyncio).* 
...
* [gevent](http://www.gevent.org/)-一个基于coroutine的Python网络库，它使用[greenlet](https://github.com/python-greenlet/greenlet)。
...
* [uvloop](https://github.com/MagicStack/uvloop)-超快速实施顶部的事件循环。
## 配置
...
* [profig](https://profig.readthedocs.io/en/latest/)-从多种格式进行值转换的配置。
* [python-decouple](https://github.com/henriquebastos/python-decouple)-设置与代码的严格分离。
## 密码学

* [cryptography](https://cryptography.io/en/latest/)-一个旨在向Python开发人员公开加密原语和配方的包。
* [paramiko](https://github.com/paramiko/paramiko)-领先的原生Python SSHv2协议库。
* [passlib](https://passlib.readthedocs.io/en/stable/)-安全密码存储/哈希库，非常高的水平。
...
* [Blaze](https://github.com/blaze/blaze)-NumPy和Pandas大数据接口。
* [Open Mining](https://github.com/mining/mining)-商业智能 (BI) 在熊猫界面。
...
* [colander](https://docs.pylonsproject.org/projects/colander/en/latest/)-验证和反序列化通过XML，JSON，HTML表单post获得的数据。
* [jsonschema](https://github.com/Julian/jsonschema)-一个实现[JSON Schema](http://json-schema.org/)对于Python。
...
* [Dash](https://plot.ly/products/dash/)-建立在烧瓶的顶部，反应和情节针对分析web应用程序。
...
* [Pygal](http://www.pygal.org/en/latest/)-一个Python SVG图表创建者。
* [PyGraphviz](https://pypi.org/project/pygraphviz/)-Python接口到[Graphviz](http://www.graphviz.org/)。
...
* MySQL-[awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/)
  * [mysqlclient](https://github.com/PyMySQL/mysqlclient-python)-支持Python 3的MySQL连接器 ([mysql-python](https://sourceforge.net/projects/mysql-python/)叉)。
  * [PyMySQL](https://github.com/PyMySQL/PyMySQL)-与mysql-python兼容的纯Python MySQL驱动程序。
* PostgreSQL-[awesome-postgres](https://github.com/dhamaniasad/awesome-postgres)
  * [psycopg2](http://initd.org/psycopg/)-最流行的Python PostgreSQL适配器。
...
* SQlite-[awesome-sqlite](https://github.com/planetopendata/awesome-sqlite)
  ...
  * [SuperSQLite](https://github.com/plasticityai/supersqlite)-一个增压SQLite库建立在顶部[apsw](https://github.com/rogerbinns/apsw)。
* 其他关系数据库
...
* [Arrow](https://arrow.readthedocs.io/en/latest/)-一个Python库，提供了一个明智的和人性化的方法来创建，操作，格式化和转换日期，时间和时间戳。
...
* [delorean](https://github.com/myusuf3/delorean/)-一个库，用于清理处理日期时间出现的不便真相。
...
* 类似pdb的调试器
  ...
  * [pdb++](https://github.com/antocuni/pdb)-pdb的另一个替换品。
  * [pudb](https://github.com/inducer/pudb)-基于控制台的全屏Python调试器。
  * [wdb](https://github.com/Kozea/wdb)-通过WebSockets不可能的web调试器。
* 追踪
...
* Profiler
  ...
  * [pyflame](https://github.com/uber/pyflame)-用于Python的ptracing探查器。
...
* [lightning](https://github.com/Lightning-AI/lightning)-深度学习框架，可快速训练、部署和运送AI产品。
## DevOps工具
...
* SSH风格部署
  ...
  * [fabtools](https://github.com/fabtools/fabtools)-编写真棒织物文件的工具。
* 流程管理
...
* [dh-virtualenv](https://github.com/spotify/dh-virtualenv)-构建并分发virtualenv作为Debian包。
...
* [pynsist](http://pynsist.readthedocs.io/en/latest/)-一个构建Windows安装程序的工具，安装程序捆绑Python本身。
...
* [django-shop](https://github.com/awesto/django-shop)-一个基于Django的商店系统。
...
* [money](https://github.com/carlospalol/money)-类具有可选的CLDR支持的区域设置感知格式和可扩展的货币兑换。
* [python-currencies](https://github.com/Alir3z4/python-currencies)-显示货币格式及其肮脏的货币。
* [saleor](https://saleor.io/)-无头开源电子商务平台。
* [shoop](https://www.shuup.com/en/)-一个基于Django的开源电子商务平台。
## 编辑器插件和ide
...
* [cffi](https://pypi.org/project/cffi/)-用于Python调用C代码的外部函数接口。
* [ctypes](https://docs.python.org/3/library/ctypes.html)-(Python标准库) 用于Python调用C代码的外部函数接口。
* [PyCUDA](https://mathema.tician.de/software/pycuda/)-Nvidia的CUDA API的Python包装器。
* [SWIG](http://www.swig.org/Doc1.3/Python.html)-简化的包装器和界面生成器。
## 表格
...
* [django-crispy-forms](https://github.com/django-crispy-forms/django-crispy-forms)-一个Django应用程序，它可以让你在一个非常优雅和干燥的方式创建美丽的形式。
* [django-remote-forms](https://github.com/WiserTogether/django-remote-forms)-一个平台独立的Django表单序列化程序。
...
* [PyGObject](https://wiki.gnome.org/Projects/PyGObject)-用于GLib/GObject/GIO/GTK (GTK 3) 的Python绑定。
...
* [tartiflette-aiohttp](https://github.com/tartiflette/tartiflette-aiohttp/)-一个-基于Tartiflette的包装器，用于通过HTTP公开GraphQL api。
* [tartiflette-asgi](https://github.com/tartiflette/tartiflette-asgi/)-ASGI对Tartiflette GraphQL引擎的支持。
...
* [GeoIP](https://github.com/maxmind/geoip-api-python)-用于MaxMind GeoIP遗留数据库的Python API。
* [geojson](https://github.com/frewsxcv/python-geojson)-用于GeoJSON的Python绑定和实用程序。
...
* [urllib3](https://github.com/shazow/urllib3)-具有线程安全连接池，文件post支持，健全友好的HTTP库。
## 硬件
...
* [Pingo](http://www.pingo.io/)-Pingo为Raspberry Pi，pcDuino，Intel Galileo等编程设备提供了统一的API。
...
* [pagan](https://github.com/daboth/pagan)-基于输入字符串和哈希的复古identicon (头像) 生成。
...
* [wand](https://github.com/dahlia/wand)-用于的Python绑定[MagickWand](http://www.imagemagick.org/script/magick-wand.php),用于ImageMagick的C API。
## 实现
...
* [Cython](http://cython.org/)-为Python优化静态编译器。
...
* [Jython](https://hg.python.org/jython)用Java编写的JVM的Python编程语言的实现。
...
* Django
  * [django-rest-framework](http://www.django-rest-framework.org/)-一个强大而灵活的工具包来构建web api。
...
* 与框架无关
  ...
  * [sanic](https://github.com/huge-success/sanic)-一个Python 3.6的web服务器和web框架，它是为了快速而编写的。
...
* [portia](https://github.com/scrapinghub/portia)-刮擦的视觉刮擦。
...
* [scrapy](https://scrapy.org/)-一个快速的高级屏幕抓取和web爬行框架。
## Web框架

*传统的全栈web框架。另请参见[RESTful API](https://github.com/vinta/awesome-python#restful-api).* 

* 同步
  * [Django](https://www.djangoproject.com/)-Python中最受欢迎的web框架。
