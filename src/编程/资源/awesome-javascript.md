...
* [Chart.js](https://github.com/chartjs/Chart.js)-使用简单的HTML5图表标签。
...
* [Numeral-js](https://github.com/adamwdraper/Numeral-js)-用于格式化和操作数字的JavaScript库。
...
* [picturefill](https://github.com/scottjehl/picturefill)-一个响应图像polyfill,srcset，尺寸。
